...
// TODO: patched from 33 to 125hz
    [TASK_RX] = DEFINE_TASK("RX", NULL, rxUpdateCheck, taskUpdateRxMain, TASK_PERIOD_HZ(125), TASK_PRIORITY_HIGH), // If event-based scheduling doesn't work, fallback to periodic scheduling
